    ...
    <div>
      ...
      {bookings.length > 0 &&
        bookings.map((booking) => (
          <Link to={`/account/bookings/${booking._id}`} className="flex bg-gray-100  rounded-2xl grow shrink-0 mt-2 mx-[]">
            <div className="">
              {booking.place.photos && booking.place.photos.length > 0 && (
                <img
                  className="rounded-tl-lg rounded-bl-lg min-w-[200px] max-w-[200px] min-h-[100px] object-cover"
                  src={
